...
//        ])
//
//        list.albumList = PhotoPickerManager.shared.fetchSmartAlbumList(albumFetchOptions: configuration.albumFetchOptions, photoFetchOptions: configuration.photoFetchOptions, showEmptyAlbum: false)
